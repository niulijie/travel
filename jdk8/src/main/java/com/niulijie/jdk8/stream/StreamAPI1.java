...
public class StreamAPI1 {
     ...
     * 1.3 skip(n)：跳过元素，返回一个扔掉了前n个元素的stream，若stream中元素不足n个，则返回一个空stream。
     *          与limit(n)互补
    ...
    public static void main(String[] args) {
        ...
        /**
         * distinct 重写了hashCode和equals方法后是3条数据，不重写是5条数据
         */
        ...
        employees.sort(new Comparator<Employee>() {
            @Override
            public int compare(Employee info1, Employee info2) {
                //获取中文环境
